...
const SearchBar = () => {
  ...
  return (
    <div className="flex flex-row gap-3 w-full h-[2rem]">
      <div className="flex flex-row items-center justify-start gap-3 w-[60%] rounded-md border px-3">
        <MagnifyingGlasses width={"1.2rem"} height={"1.2rem"} />
        <input className="w-full" type="text" placeholder="기업명 또는 직무를 입력하세요" />
      </div>
      <div className="flex flex-row items-center justify-between gap-1 w-[40%]">
        <div className="w-[50%]">
          <Dropdown
